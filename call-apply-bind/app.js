...
console.log(sumEvenArguments(1, 8, 3, 4, 3, 8, 6));
...
addOnlyThreeTimes(1, 2)
addOnlyThreeTimes(2, 2)
...
var instructor = { firstName: "Jrod" }
var doMathOnce = once(doMath, instructor);
console.log(doMathOnce(1, 8, 9));
...
function flip(fn, thisArg) {
  ...
  var flipFn = flip(personSubtract, person);
  console.log(flipFn(8, 2, 1));
  
   // "Elie subtracts -4"

  var flipFn2 = flip(personSubtract, person, 7, 8);
  console.log(flipFn2(8, 9));
  ...
  console.log(flip(subtractFourNumbers, this, 1)(2, 3, 8));
